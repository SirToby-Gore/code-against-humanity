def get_white_cards() -> str:    
    return '\n'.join([
        ...
        'Roland the farther, flautist to the king',
        ...
        'Yelling \'silencio\' during a tv show',
        'Russians',
        ...
        'Used tissues in the night-stand',
        'Time travel',
        'The world\'s smallest violin',
        'Getting abducted by peter pan',
        'Yelling \'silencio\' during a game night',
        ...
        'Warm toilet seats',
        'Too many shots',
        'Dining with cardboard cut-outs of the cast of friends',
        'Toxic masculinity',
        'War heroes',
        ...
        'Sniffing glue',
        'The only gay person in one hundred miles',
        'Getting naked and watching CBBC',
        'Dead parents',
        ...
        'Poor people',
        'A fleshlight',
        'Queen elizabeth\'s emasculate anus',
...
def get_black_cards() -> str:    
    return '\n'.join([
        ...
        'This evening, Nathan will be doing a {} to the theme of {}.',
        'At dusk Isaac puts on the mask becoming {} by night.',
        'Toby has got a whole cupboard dedicated to {}.',
        'Matthew is wishing for {} right now.',
        'Chola has got a secret talent for {}.',
        'Kian\'s favourite Minecraft mod turns all the characters into {}.',
        'Peter recently did {}, because he was board.',
        'Catharine is also an expert in teaching advanced courses on {}.',
